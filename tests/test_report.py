...
def test_the_mitre_disclaimer_is_always_present(db, analyst):
    for job in (disk_job(db, analyst), memory_job(db, analyst)):
        assert "investigative leads" in text_of(render(job))
